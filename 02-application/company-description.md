# Company Description (sezione application)

> Sezione "Company / Startup Description" del form PLAI.
> Target: 800–1.200 caratteri (controllare limite reale del form al momento della compilazione).
> Tono: editoriale, asciutto. Niente AI-startup-clichés.
...
Sede operativa: Italia. Lingua di produzione: italiano (con possibilità di estensione a EN/ES/FR). Stadio: pre-seed, MVP in pilot validation.

---

## Note di compilazione
- Se il form chiede meno di 500 caratteri: tagliare al primo + ultimo paragrafo.
- Se il form chiede oltre 2.000 caratteri: aggiungere paragrafo su traction (LOI/pilot in corso) + paragrafo su uso fondi PLAI.
- Mai usare la parola "rivoluzionare". Mai "leverage". Mai "AI-powered solution".
- Citare Pequod e Filologia Moderna **una volta sola** in tutto il form, non in ogni sezione.

## Da personalizzare prima del submit
- [ ] Verificare numero esatto manoscritti/anno (fonte: AIE o conversazioni dirette con editori)
- [ ] Aggiornare stage se MVP non è ancora in pilot validation al momento del submit
- [ ] Adeguare lunghezza al limite reale del form PLAI
