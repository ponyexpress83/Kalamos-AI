...
2026-08-06 | align     | Revisione dei materiali dopo la seconda analisi esterna. (1) L'ask non fonde più i due strumenti PLAI: fino a €300K di equity e fino a €100K di collaborazione operativa sono separati, e la percentuale non si propone. (2) Tolti i claim di volume senza fonte in nove file ("meno del 15%", "8.000-15.000", "5.000-20.000", "il 95%"), sostituiti da una formulazione non attaccabile; la stima in market-sizing resta ma marcata. (3) Il fossato diventa un meccanismo da attivare, non un fatto acquisito. (4) Nuova scheda concorrenti verificata: Storywise (più avanti di noi), Schilling, Ingenta. (5) Posizionamento "sistema di intelligenza, non di registrazione" in differentiation, Q&A e briefing. (6) Tre formule ritirate: "finito però da implementare", l'estratto come limite, il confronto costi a un millesimo. (7) Segnalata l'incoerenza sui founder fra F6S e materiali recenti — nodo da sciogliere, non da improvvisare
