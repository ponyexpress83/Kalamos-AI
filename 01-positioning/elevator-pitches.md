# Elevator Pitches — 30s / 60s / 3min

> Tre versioni dello stesso messaggio per contesti diversi. Memorizzarle, non leggerle.
...
>
> Il fit con PLAI è quasi caricaturalmente forte: Publishing è una delle vostre 5 aree prioritarie, Mondadori è il nostro cliente perfetto, e abbiamo già una proposta operativa pronta da firmare. Vorremmo iniziare.

**Quando usarla**: pitch formale (Demo Day, colloquio investitori, intervista lunga), versione narrativa di una candidatura, prima conversazione con un mentore importante.

---

## Note di delivery

- **Velocità**: non andare di fretta. 3 minuti = 450 parole è la velocità lenta-naturale. Se devi correre per finire, hai messo troppi contenuti.
- **Pause**: dopo "Il problema." / "La nostra risposta." / "Perché noi." → 1 secondo di pausa, lasciar respirare.
- **Tono**: editoriale, non da bootcamp americano. Pensa Adelphi, non Y Combinator.
- **Cosa NON fare**: "I'm passionate about", "We're disrupting", "It's like Spotify for books". Mai.
